...
class CreateBinanceFourHourCandlesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('binance_four_hour_candles', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('binance_four_hour_candles');
    }
}

...
class CreateTinkoffHourCandlesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tinkoff_hour_candles', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('tinkoff_hour_candles');
    }
}

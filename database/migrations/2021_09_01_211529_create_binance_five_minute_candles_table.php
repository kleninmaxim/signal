...
class CreateBinanceFiveMinuteCandlesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('binance_five_minute_candles', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('binance_five_minute_candles');
    }
}

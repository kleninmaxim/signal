...
class CreateBinanceHourCandlesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('binance_hour_candles', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('binance_hour_candles');
    }
}

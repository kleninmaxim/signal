...
class CreateTinkoffWeekCandlesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tinkoff_week_candles', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('tinkoff_week_candles');
    }
}

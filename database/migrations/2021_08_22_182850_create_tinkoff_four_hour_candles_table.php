...
class CreateTinkoffFourHourCandlesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tinkoff_four_hour_candles', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('tinkoff_four_hour_candles');
    }
}

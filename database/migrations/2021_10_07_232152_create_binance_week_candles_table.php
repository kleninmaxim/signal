...
class CreateBinanceWeekCandlesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('binance_week_candles', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('binance_week_candles');
    }
}
